...
<html lang="en">
    ...
    <?php
        ...
        $goods_that_move_fast=getGoodsThatMovesFast();
    ?>
	<body>
        <nav class="nav-main">
        ...
        <main style="height:93%" class="mt-3">
            <div class="container">
                <?php
                foreach($goods_that_move_fast as $product){
                ?>
                <div class="p-3 mb-2  text-black rounded-pill d-flex justify-content-around fs-3 mt-5 custom-bar">
                    ...
                    <div class="d-flex justify-content-center" style="width:60%"><span style="color:#851c2a">Quantity Sold: <?=$product['Quantity_Sold']?></span></div>
